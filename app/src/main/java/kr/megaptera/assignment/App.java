...
public class App {
    ...
    private static String processDeleteTask(Map<Long, String> tasks, String method) {
    ...
    private static Long parseTaskId(String method) {
        ...
        Long result = Long.parseLong(parts[2].trim());
        System.out.println("parseTaskId : " + result);
        return result;
    }
